(function() {
    ...
    angular.module('app')
    .controller('TalkDetailCtrl', ['$scope','$stateParams','Talks','Messages','Users','$ionicScrollDelegate','$interval',
        'LoadingPopup', function ($scope, $stateParams, Talks, Messages, Users, $ionicScrollDelegate,$interval, LoadingPopup) {
